...
/* ---------- Fallback data (used only if /assets/data/*.json are missing) ---------- */
...
function addCityMarker(city) {
  ...
  cityCluster.addLayer(
    L.marker([city.lat, city.lng]).bindPopup(
...
function addStadiumMarker(st) {
  ...
  const html = `
    ...
    https://wa.me/14155238886?text=${wa}Get match‑day details on WhatsApp</a>
